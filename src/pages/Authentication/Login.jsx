  ...
  return (
    <div className="login-page-custom-bg">
      <Container className="d-flex flex-column justify-content-center align-items-center min-vh-100">
        ...
        <div className="text-center mb-2">
          <span className="fw-bold" style={{ fontSize: "1.6rem", color: "#f3e6fa", letterSpacing: 1 }}>LOGIN</span>
        </div>
        <Form
        ...
        >
          ...
          <div className="mb-3 position-relative">
            <Label className="form-label text-white fw-bold" style={{ fontSize: '1.1rem', marginBottom: 4 }}>E-mail</Label>
            <Input
              name="email"
          ...
          <div className="mb-3 position-relative">
            <Label className="form-label text-white fw-bold" style={{ fontSize: '1.1rem', marginBottom: 4 }}>Senha</Label>
            <Input
              name="password"
          ...
          <button
            ...
            type="submit"
            style={{ background: "#7c4bc0", border: "none", fontSize: "1.1rem", letterSpacing: 0.5 }}
            disabled={loading}
          >
            {loading ? (
              <>
          ...
          <div className="text-center mt-3">
            <Link to="/forgot-password" className="text-white-50" style={{ fontSize: "0.98rem" }}>
              Esqueceu a senha?
            </Link>
          </div>
        </Form>
