                            ...
                            <Col md={6}>
                              <div className="mb-3">
                                ...
                                <Input
                                  type="text"
                                  name="registration"
                                  value={isEditing ? editForm.registration : (userData.professionalInfo?.registration || '')}
                                  onChange={handleInputChange}
                                  disabled={!isEditing}
                                />
                              </div>
                      ...
                      <Card>
                        <CardBody>
                          ...
                          <Row>
                            ...
                            <Col md={6}>
                            <div>
                            <Label className="bottom-2">Materias</Label>
                            <div>
                            {userData.professionalInfo?.subjects.map((materia, index) => (
                                <span key={index} className="badge bg-primary me-1 p-1 fs-6">
                                    {materia}
                                </span>
                            ))}
                            </div>
