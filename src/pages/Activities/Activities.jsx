...
const Activities = () => {
  const { getActivities, deleteActivity, loading, error } =
  ...
  const handleGoToActivity = (activity) => {
    navigate(
      `/activities/activity/${activity.id}/${activity.class.id}/${activity.subject.id}`
    );
  };

  const handleEdit = (activity) => {
    navigate(
      `/activities/edit-activity/${activity.id}/${activity.class.id}/${activity.subject.id}`
    );
  };
