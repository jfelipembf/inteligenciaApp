...
const GestorDashboard = (props) => {
  ...
  const financialChartOptions = {
    series: [
      {
        name: "Receitas",
        data: [12500, 13200, 12800, 14500, 15200, 14800, 15500, 16200, 15800, 16500, 17200, 17800]
      },
      {
        name: "Despesas",
        data: [9500, 9800, 9600, 10200, 10500, 10300, 10800, 11200, 11000, 11500, 11800, 12000]
      }
    ],
    options: {
      chart: {
                    ...
                    <TabPane tabId="1">
                      <Row>
                        <Col xl={8}>
                          <Card>
                            <CardBody>
                              <CardTitle className="mb-4">Receitas x Despesas (Anual)</CardTitle>
                              <ReactApexChart
                        ...
                        <Col xl={4}>
                          <Card>
                            <CardBody>
                              <CardTitle className="mb-4">Distribuição de Alunos</CardTitle>
                              <ReactApexChart
                          ...
                          <Card>
                            <CardBody>
                              <CardTitle className="mb-4">Estatísticas Gerais</CardTitle>
                              <div className="mt-3">
                                <p className="font-size-15 mb-1">Professores</p>
                                <h4>{totalTeachers}</h4>
                              </div>
                              <div className="mt-3">
                                <p className="font-size-15 mb-1">Funcionários</p>
                                <h4>{totalStaff}</h4>
                              </div>
                              <div className="mt-3">
                      ...
                      <Row>
                        <Col xl={6}>
                          <Card>
                            <CardBody>
                              <CardTitle className="mb-4">Turmas com Melhor Desempenho</CardTitle>
                    ...
                    <TabPane tabId="2">
                      <Row>
                        <Col xl={6}>
                          <Card>
                            <CardBody>
                              ...
                              <div className="mt-3">
                                <p className="font-size-15 mb-1">Receita Mensal</p>
                                <h4>R$ {financialData.receitas.toLocaleString('pt-BR')}</h4>
                              </div>
                              <div className="mt-3">
                                <p className="font-size-15 mb-1">Despesas Mensais</p>
                                <h4>R$ {financialData.despesas.toLocaleString('pt-BR')}</h4>
                              </div>
                              <div className="mt-3">
                                <p className="font-size-15 mb-1">Lucro</p>
                                <h4>R$ {(financialData.receitas - financialData.despesas).toLocaleString('pt-BR')}</h4>
                              </div>
                              <div className="mt-3">
                                <p className="font-size-15 mb-1">Mensalidade Média</p>
                                <h4>R$ {financialData.mensalidadeMedia.toLocaleString('pt-BR')}</h4>
                              </div>
                              <div className="mt-4">
                                <Link to="/financeiro" className="btn btn-primary w-md">
                                  Ver Detalhes
                                </Link>
                              </div>
                            </CardBody>
                        ...
                        <Col xl={6}>
                          <Card>
                            <CardBody>
                              <CardTitle className="mb-4">Inadimplência por Turma</CardTitle>
                              <div className="table-responsive">
                                <Table className="table-centered table-nowrap mb-0">
                                  <thead className="table-light">
                                    <tr>
                                  ...
                                  <tbody>
                                    {defaultRateByClass.map((item, index) => (
                                      <tr key={index}>
                                        ...
                                        <td>
                                          <Badge 
                                            color={item.rate > 10 ? "danger" : item.rate > 5 ? "warning" : "success"} 
                                            pill
                                          >
                                            {item.rate > 10 ? "Alto" : item.rate > 5 ? "Médio" : "Baixo"}
                                          </Badge>
                                        </td>
                                      </tr>
                                    ))}
                    ...
                    <TabPane tabId="3">
                      <Row>
                        <Col xl={4}>
                          <Card>
                            <CardBody>
                              <CardTitle className="mb-4">Estatísticas Acadêmicas</CardTitle>
                              <div className="mt-3">
                                <p className="font-size-15 mb-1">Total de Alunos</p>
                                <h4>{totalStudents}</h4>
                              </div>
                              <div className="mt-3">
                                <p className="font-size-15 mb-1">Total de Professores</p>
                                <h4>{totalTeachers}</h4>
                              </div>
                              <div className="mt-3">
                                <p className="font-size-15 mb-1">Total de Turmas</p>
                                <h4>{totalClasses}</h4>
                              </div>
                              <div className="mt-3">
                              ...
                              <div className="mt-3">
                                <p className="font-size-15 mb-1">Taxa de Aprovação</p>
                          ...
                          <Card>
                            <CardBody>
                              ...
                              <Row>
                                ...
                                <Col md={6}>
                                  <div className="mt-3">
                                    <p className="font-size-15 mb-1">Alunos por Turma (Média)</p>
                                    <h4>{Math.round(totalStudents / (totalClasses || 1))}</h4>
                                  </div>
                                  <div className="mt-3">
                                    <p className="font-size-15 mb-1">Alunos por Professor (Média)</p>
                                    <h4>{Math.round(totalStudents / (totalTeachers || 1))}</h4>
                                  </div>
                                  <div className="mt-3">
                                    <p className="font-size-15 mb-1">Turmas por Professor (Média)</p>
                                    <h4>{(totalClasses / (totalTeachers || 1)).toFixed(1)}</h4>
                                  </div>
                                </Col>
                              </Row>
                            </CardBody>
