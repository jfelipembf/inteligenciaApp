        ...
        <CardBody className="pt-0">
          <Row>
            <Col sm="4">
              ...
              <h5 className="font-size-15 text-truncate">{studentData.name}</h5>
              <p className="text-muted mb-0 text-truncate">Matrícula: {studentData.registration}</p>
            </Col>
            <Col sm="8">
              <div className="pt-4">
                <Row>
                  <Col xs="6">
                    <h5 className="font-size-15">{studentData.grade}</h5>
                    <p className="text-muted mb-0">Turma: {studentData.class}</p>
                  </Col>
                  <Col xs="6">
                    <div className="d-flex align-items-start justify-content-between">
                      <div className="text-center" style={{ minWidth: '80px' }}>
                        <Badge
                          color={studentData.status === "active" ? "success" : "warning"}
