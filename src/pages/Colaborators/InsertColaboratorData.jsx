...
const InsertColaboratorData = () => {
  const navigate = useNavigate();
  const { updateColaborator, loading, error } = useColaborator();
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumb title="Coordenadores" breadcrumbItem="Novo Coordenador" />
          <Row>
            <Col lg={12}>
              <Card>
                <CardBody>
                  <h4 className="card-title mb-4">Insira seus dados</h4>
...
export default InsertColaboratorData;
