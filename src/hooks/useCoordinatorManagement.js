...
export const useCoordinatorManagement = () => {
  ...
  const createCoordinator = async ({
    ...
    try {
      console.log("Iniciando criação do coordenador...");
      ...
      console.log("Criando coordenador no Firebase Auth...");
      const userCredential = await firebase
        .auth()
        .createUserWithEmailAndPassword(email, password);
      console.log("Coordenador criado com sucesso:", userCredential);
      ...
      console.log("Salvando dados do coordenador no Firestore:", finalUserData);
      await firebase
        .firestore()
        .collection("users")
        .doc(newUserUid)
        .set(finalUserData);
      console.log("Coordenador salvo no Firestore com sucesso.");
