...
export const useAdministratorManagement = () => {
  ...
  const createAdministrator = async ({
    ...
    try {
      ...
      console.log("Criando administrador no Firebase Auth...");
      const userCredential = await firebase
        .auth()
        .createUserWithEmailAndPassword(email, password);
      console.log("Administrador criado com sucesso:", userCredential);
      ...
      console.log(
        "Salvando dados do administrador no Firestore:",
        finalUserData
      );
      await firebase
        .firestore()
        ...
        .doc(newUserUid)
        .set(finalUserData);
      console.log("Administrador salvo no Firestore com sucesso.");
      ...
      try {
        ...
        if (user && user.email === email) {
          console.log(
            "Removendo administrador criado no Auth devido a erro..."
          );
          await user.delete();
        }
      } catch (deleteError) {
