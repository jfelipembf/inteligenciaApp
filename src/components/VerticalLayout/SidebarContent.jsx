          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                ...
                <li>
                  <Link to="/dashboard-financeiro">{props.t("Financeiro")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/schools">{props.t("Lista de Escolas")}</Link>
                </li>
                <li>
                  <Link to="/schools/new">{props.t("Nova Escola")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/financeiro/caixa">{props.t("Caixa")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                ...
                <li>
                  <Link to="/financeiro/fluxo-caixa">{props.t("Fluxo de Caixa")}</Link>
                </li>
                <li>
                  <Link to="/financeiro/contas-receber">{props.t("Contas a Receber")}</Link>
                </li>
                <li>
                  <Link to="/financeiro/contas-pagar">{props.t("Contas a Pagar")}</Link>
                </li>
              </ul>
            </li>
