...
const menuItems = [
  ...
  {
    icon: "bx bx-line-chart", label: "Dashboards", children: [
  ...
  {
    icon: "bx bx-user-pin", label: "Colaboradores", children: [
  ...
  {
    icon: "bx bx-message-square-dots", label: "Comunicação", children: [
      { label: "Mensagens", to: "/messages" },
      { label: "Notificações", to: "/notifications" },
    ]
  },
  {
    icon: "bx bx-group", label: "Turmas", children: [
  ...
  {
    icon: "bx bx-calendar-event", label: "Eventos", children: [
...
const PinkSidebar = () => {
  ...
  return (
    <nav className="sidebar-menu-no-bg">
        ...
        item.children ? (
          <div key={idx} className="sidebar-menu-group">
            ...
            >
              ...
              <i className={`bx bx-chevron-${openMenu === idx ? "up" : "down"} ms-auto`}></i>
            </button>
            {openMenu === idx && (
              <div className="sidebar-submenu">
                {item.children.map((sub, subIdx) => (
                  <NavLink to={sub.to} className="sidebar-btn-no-bg sidebar-btn-sub" key={subIdx} end>
                    <span>{sub.label}</span>
                  </NavLink>
                ))}
              </div>
